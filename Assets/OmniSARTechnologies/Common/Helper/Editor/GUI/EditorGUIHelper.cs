    ...
    public static class EditorGUIHelper
    {
        public static class Attributes
        {
                ...
                SerializedProperty serializedProperty, bool inherit = true)
            {
                ...
                var field = typeof(Type).GetField(serializedProperty.name);
            ...
            public static string GetFieldDisplayName(FieldInfo field, bool inherit = true)
            {
                ...
                var attribute = GetFieldFirstAttribute<DisplayNameAttribute>(field, inherit);
            ...
            public static string GetFieldTooltip(FieldInfo field, bool inherit = true)
            {
                ...
                var attribute = GetFieldFirstAttribute<TooltipAttribute>(field, inherit);
            ...
            public static Vector2 GetFieldFloatRange(FieldInfo field, bool inherit = true)
            {
                ...
                var attribute = GetFieldFirstAttribute<RangeAttribute>(field, inherit);
        ...
        public static class GUIContentHelper
        {
                ...
                string displayName = default)
            {
                ...
                {
                    var attributeDisplayName = Attributes.GetSerializedPropertyDisplayName<Type>(serializedProperty);
                    displayName = default == attributeDisplayName
                        ? serializedProperty.displayName
                        : attributeDisplayName;
                }

                var tooltip = Attributes.GetSerializedPropertyTooltip<Type>(serializedProperty);
        ...
        public static class Drawing
        {
                ...
                Color fontColor = default, FontStyle fontStyle = default, bool dropShadow = true)
            {
                ...
                var size = labelStyle.CalcSize(textContent);
                pivot.Scale(size);
                position -= pivot;
            ...
            {
                var label = GUIContentHelper.GetSerializedPropertyGUIContent<Type>(serializedProperty, displayName);
