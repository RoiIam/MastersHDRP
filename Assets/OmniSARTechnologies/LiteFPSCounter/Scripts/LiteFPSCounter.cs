...
namespace OmniSARTechnologies.LiteFPSCounter
{
    ...
    public class LiteFPSCounter : MonoBehaviour
    {
        ...
        private readonly Color m_CPUFieldsColor = ColorHelper.HexStrToColor("#0090CBFF");
        private string m_DynamicConfigurationFormat;

        private readonly Color m_FPSFieldsColor = ColorHelper.HexStrToColor("#80FF00FF");
        private readonly Color m_FPSFluctuationFieldsColor = ColorHelper.HexStrToColor("#DCEC00FF");
        private readonly Color m_FPSMaxFieldsColor = ColorHelper.HexStrToColor("#00A0FFFF");
        private readonly Color m_FPSMinFieldsColor = ColorHelper.HexStrToColor("#FF8400FF");
        private readonly Color m_GPUDetailFieldsColor = ColorHelper.HexStrToColor("#FF3379FF");
        private readonly Color m_GPUFieldsColor = ColorHelper.HexStrToColor("#FF5020FF");
        private float m_LastUpdateTime;
        private string m_StaticInfoDisplay;
        private readonly Color m_SysFieldsColor = ColorHelper.HexStrToColor("#C9D700FF");
