...
namespace OmniSARTechnologies.LiteFPSCounter
{
    ...
    public class LiteFPSCounterEditor : Editor
    {
        ...
        public static void DrawComponentHeader()
        {
            ...
            {
                var drawingAreaRect = EditorGUILayout.GetControlRect(GUILayout.MaxHeight(34));
                ...
                var headerImageRect = new Rect(headerRect) { width = m_HeaderTex.width };
                headerImageRect.width = m_HeaderTex.width;
                GUI.DrawTexture(headerImageRect, m_HeaderTex);

                var headerImageTileRect = new Rect(headerRect);
        ...
        {
            var assets = AssetDatabase.FindAssets(prefabName + " t:Prefab");
            ...
            var prefabPath = AssetDatabase.GUIDToAssetPath(assets[0]);
            ...
            var go = Instantiate(prefab, Selection.activeGameObject ? Selection.activeGameObject.transform : null);
            go.name = prefabName;
