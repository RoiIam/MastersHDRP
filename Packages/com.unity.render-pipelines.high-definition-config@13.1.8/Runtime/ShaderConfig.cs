...
namespace UnityEngine.Rendering.HighDefinition
{
    ...
    public enum ShaderOptions
    {
        ...
        CameraRelativeRendering = 0, //RCC disable CameraRelativeRendering

        /// <summary>Uses pre-exposition to enhance color precision.</summary>
        PreExposition = 1,

        /// <summary>
        ///     Precomputes atmospheric attenuation for the directional light on the CPU. This makes it independent from the
        ///     fragment's position, which increases performance but reduces accuracy.
        /// </summary>
        ...
        /// <summary>
        ///     Maximum number of lights for a fine pruned light tile. This number can only be the prespecified possibilities in
        ///     FPTLMaxLightSizes
        ///     Lower count will mean some memory savings.
        ///     Note: For any rendering bigger than 4k (in native) it is recommended to use Low count per tile, to avoid possible
        ///     artifacts.
        /// </summary>
    ...
    public class ShaderConfig
    {
        ...
        /// <summary>
        ///     Indicates whether to use [camera-relative rendering](../manual/Camera-Relative-Rendering.md) to enhance
        ///     precision.
        /// </summary>
