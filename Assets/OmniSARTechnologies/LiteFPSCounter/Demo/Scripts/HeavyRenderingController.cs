...
namespace OmniSARTechnologies.LiteFPSCounter.Examples
{
    public class HeavyRenderingController : MonoBehaviour
    {
        ...
        [Range(0, 1)] public float complexity = 0.05f;
        ...
        {
            if (!heavyRenderingMaterial) return 0.0f;
        ...
        public void SetComplexity(float value)
        {
            ...
            if (heavyRenderingMaterial) heavyRenderingMaterial.SetFloat("_Complexity", Mathf.Clamp01(complexity));
